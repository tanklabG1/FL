...
__attribute__((section("__versions"))) = {
	...
	{ 0xc5cf36a0, __VMLINUX_SYMBOL_STR(ovs_vxlan_fill_metadata_dst) },
	{ 0x79ad6f36, __VMLINUX_SYMBOL_STR(rpl_vxlan_xmit) },
	...
	{ 0xcae06f40, __VMLINUX_SYMBOL_STR(rpl_vxlan_dev_create) },
