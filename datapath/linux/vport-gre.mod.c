...
__attribute__((section("__versions"))) = {
	...
	{ 0x888a0b6f, __VMLINUX_SYMBOL_STR(ovs_gre_fill_metadata_dst) },
	{ 0x37c352ad, __VMLINUX_SYMBOL_STR(rpl_gre_fb_xmit) },
	...
	{ 0x88a089ae, __VMLINUX_SYMBOL_STR(rpl_gretap_fb_dev_create) },
